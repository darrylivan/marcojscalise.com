          ...
          <div className="container clearfix">
              ...
              */ }
              <div id="logo" className="divcenter">
                  <a href="index-agency.html" className="standard-logo">
                      <img className="divcenter" src="../html/demos/agency/images/logo-agency.png" alt="Canvas Logo" />
                  </a>
                  <a href="index-agency.html" className="retina-logo">
                      <img className="divcenter" src="demos/agency/images/logo-agency@2x.png" alt="Canvas Logo" />
                  </a>
              </div>{ /*  <!-- #logo end --> */ }
          ...
          <div id="header-wrap">
              ...
              <nav id="primary-menu" className="style-2 center">
                  ...
                  <div className="container clearfix">
                      ...
                      <ul className="sf-js-enabled" style="touch-action: pan-y;">
                          ...
                          <li className="sub-menu"><a href="#" className="sf-with-ul"><div>Features</div></a>
                              <ul style="display: none;">
                                  <li className="sub-menu"><a href="#" className="sf-with-ul"><div><i className="icon-stack"></i>Sliders</div></a>
                                      <ul style="display: none;">
                                  ...
                                  <li className="sub-menu"><a href="#" className="sf-with-ul"><div><i className="icon-umbrella"></i>Headers</div></a>
                                      <ul style="display: none;">
                                  ...
                                  <li className="sub-menu"><a href="#" className="sf-with-ul"><div><i className="icon-align-justify2"></i>Menu Styles</div></a>
                                      <ul style="display: none;">
                                  ...
                                  <li className="sub-menu"><a href="#" className="sf-with-ul"><div><i className="icon-ok-sign"></i>Page Titles</div></a>
                                      <ul style="display: none;">
                                  ...
                                  <li className="sub-menu"><a href="#" className="sf-with-ul"><div><i className="icon-calendar3"></i>Events</div></a>
                                      <ul style="display: none;">
                          ...
                          <li className="mega-menu sub-menu"><a href="#" className="sf-with-ul"><div>Pages</div></a>
                              <div className="mega-menu-content style-2 clearfix" style="display: none;">
                                  <ul className="mega-menu-column col-md-3">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Introduction</div></a>
                                          <ul style="display: none;">
                                  ...
                                  <ul className="mega-menu-column col-md-3">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Utility</div></a>
                                          <ul style="display: none;">
                                  ...
                                  <ul className="mega-menu-column col-md-3">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Layout Grids</div></a>
                                          <ul style="display: none;">
                                  ...
                                  <ul className="mega-menu-column col-md-3">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Miscellaneous</div></a>
                                          <ul style="display: none;">
                          ...
                          <li className="mega-menu sub-menu"><a href="#" className="sf-with-ul"><div>Portfolio</div></a>
                              <div className="mega-menu-content style-2 clearfix" style="display: none;">
                                  <ul className="mega-menu-column col-5">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Grids</div></a>
                                          <ul style="display: none;">
                                  ...
                                  <ul className="mega-menu-column col-5">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Masonry</div></a>
                                          <ul style="display: none;">
                                  ...
                                  <ul className="mega-menu-column col-5">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Loading Styles</div></a>
                                          <ul style="display: none;">
                                  ...
                                  <ul className="mega-menu-column col-5">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Single Project</div></a>
                                          <ul style="display: none;">
                                  ...
                                  <ul className="mega-menu-column col-5">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Layouts</div></a>
                                          <ul style="display: none;">
                          ...
                          <li className="mega-menu sub-menu"><a href="#" className="sf-with-ul"><div>Blog</div></a>
                              <div className="mega-menu-content style-2 clearfix" style="display: none;">
                                  <ul className="mega-menu-column col-md-3">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Default</div></a>
                                          <ul style="display: none;">
                                      ...
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Timeline</div></a>
                                          <ul style="display: none;">
                                  ...
                                  <ul className="mega-menu-column col-md-3">
                                      ...
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Grid</div></a>
                                          <ul style="display: none;">
                                  ...
                                  <ul className="mega-menu-column col-md-3">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Small Thumbs</div></a>
                                          <ul style="display: none;">
                                      ...
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Item Splitting</div></a>
                                          <ul style="display: none;">
                                  ...
                                  <ul className="mega-menu-column col-md-3">
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Single</div></a>
                                          <ul style="display: none;">
                                      ...
                                      <li className="mega-menu-title sub-menu"><a href="#" className="sf-with-ul"><div>Comments Module</div></a>
                                          <ul style="display: none;">
                          ...
                          <li className="sub-menu"><a href="shop.html" className="sf-with-ul"><div>Shop</div></a>
                              <ul style="display: none;">
                                  <li><a href="shop.html"><div>4 Columns</div></a></li>
                                  <li className="sub-menu"><a href="shop-3.html" className="sf-with-ul"><div>3 Columns</div></a>
                                      <ul style="display: none;">
                                  ...
                                  <li className="sub-menu"><a href="shop-2.html" className="sf-with-ul"><div>2 Columns</div></a>
                                      <ul style="display: none;">
                                  ...
                                  <li className="sub-menu"><a href="shop-1.html" className="sf-with-ul"><div>1 Columns</div></a>
                                      <ul style="display: none;">
                                  ...
                                  <li className="sub-menu"><a href="shop-single.html" className="sf-with-ul"><div>Single Product</div></a>
                                      <ul style="display: none;">
                          ...
                          <li className="mega-menu sub-menu"><a href="#" className="sf-with-ul"><div>Shortcodes</div></a>
                              <div className="mega-menu-content clearfix" style="display: none;">
                                  <ul className="mega-menu-column col-5">
                                  ...
                                  <ul className="mega-menu-column col-5">
                                      ...
                                      <li><a href="component-editable.html"><div><i className="icon-edit"></i>Editable Fields</div></a></li>
